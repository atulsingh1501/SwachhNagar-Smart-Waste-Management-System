...
// Pickup Requests API functions
export async function fetchPickupRequests(token: string) {
...
export async function fetchCitizenPickupRequests(citizenId: string, token: string) {
  const response = await fetch(`${API_BASE_URL}/pickup-requests/citizen/${citizenId}`, {
    headers: { 'Authorization': `Bearer ${token}` }
  });
  if (!response.ok) throw new Error('Failed to fetch citizen pickup requests');
  return response.json();
}

export async function createPickupRequest(requestData: any, token: string) {
  const response = await fetch(`${API_BASE_URL}/pickup-requests`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
export async function updatePickupRequest(requestId: string, requestData: any, token: string) {
  const response = await fetch(`${API_BASE_URL}/pickup-requests/${requestId}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`
...
export async function updatePickupRequestStatus(requestId: string, status: string, notes: string, token: string) {
  ...
  if (!response.ok) throw new Error('Failed to update pickup request status');
  return response.json();
}

export async function deletePickupRequest(requestId: string, token: string) {
  const response = await fetch(`${API_BASE_URL}/pickup-requests/${requestId}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${token}` }
  });
