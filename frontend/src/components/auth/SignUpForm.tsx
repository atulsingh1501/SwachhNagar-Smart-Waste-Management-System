      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">Join the Waste Management System</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="assignedArea" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 text-white py-2 sm:py-3 px-3 sm:px-4 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm sm:text-base"
            >
